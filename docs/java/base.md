...
[simple run after Java 9](../../java/module-info-example/build.sh)
                ...
                └── org
                    └── example
                        └── main
                            └── App.java
```
[App.java](../../java/module-info-example/main/src/main/java/org/example/main/App.java)
...
### Java 逆变
[ContravarianceDemo.java](../../java/java-example/src/main/java/com/example/ContravarianceDemo.java)
