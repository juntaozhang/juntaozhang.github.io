...
/**
 * jvm args:
 * --add-opens=java.base/sun.nio.ch=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.nio=ALL-UNNAMED
 * <p>
...
public class IcebergS3Example {
    ...
    public static void main(String[] args) {
        SparkSession spark = SparkSession.builder()
                ...
                .config("spark.hadoop.fs.s3a.secret.key", "11111111")
                .config("spark.hadoop.fs.s3a.endpoint", "http://localhost:32000")
