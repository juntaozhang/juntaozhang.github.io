...
public class VisitorClient {
  ...
  static class EnterpriseCustomer extends Customer {
    private int size;
   ...
   * 具体的访问者，实现对客户的偏好分析
   */
  static class PredilectionAnalyzeVisitor implements Visitor {
    @Override
   ...
   */
  static class ServiceRequestVisitor implements Visitor {
